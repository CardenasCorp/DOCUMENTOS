    ...
    <body>
                        ...
                        <div id="supervisor-verificadores-section">
                            ...
                            <div class="form-group-7">
                                <div class="verificador form-control-2" id="verificadores">
                                    ...
                                    <!-- Contenedor para verificadores -->
                                    <div class="verificador-container">
                                        <!-- Los verificadores se agregarán aquí dinámicamente -->
                                    </div>
                                    <div class="input-container">    
                        ...
                        <div id="funcionarios-section" class="hidden">
                            <div class="form-group-8">
                                <div class="funcionarios form-control-2" id="funcionarios">
                                    ...
                                    <div class="input-container">    
                                        <button type="button" class="plus" onclick="agregarFuncionario()">Agregar</button>      
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.getElementById('fecha-notificacion').value = today;
                
                // Calcular fecha de presentación (por ejemplo, 15 días después)
                const presentarDate = new Date();
                presentarDate.setDate(presentarDate.getDate() + 15);
                document.getElementById('fecha-presentar').value = presentarDate.toISOString().split('T')[0];
            });
        </script>
    </body>
