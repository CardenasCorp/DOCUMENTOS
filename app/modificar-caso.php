...
<body>
            ...
            <div class="form-section">
                ...
                <form class="form-container">
                    <div class="form-group-1">
                        <div class="number form-control-2">
                            <label for="number">Documento</label>
                            <div class="input-container">
                                <input type="text" id="number" name="number" placeholder="Busque el número de documento"
                                    required disabled>
                    ...
                    <div class="form-group-2">
                        <div class="empresa form-control-2">
                            ...
                            <div class="input-container">
                                <input type="text" id="requerimiento" name="requerimiento" class="form-control"
                                    placeholder="Ingrese la empresa" required disabled>
                                <button type="button" class="search-business" id="openModalButtonBusiness"><i
                    ...
                    <div class="form-group-7">
                        <div class="verificador form-control-2" id="verificadores">
                            ...
                            <div class="verificador-container">
                                <div class="input-container">
                                    <input type="text" id="verificador1" name="verificador1"
                                        placeholder="Nombre del verificador" required>
                                    <button type="button" class="plus" onclick="agregarVerificador()"><i
    ...
    <div id="myModalDoc" class="myModalDoc modal">
        <div class="modal-content">
            <span class="close" id="closeModalDoc">&times;</span> <!-- Cierre único -->
            <h2>Buscar documento</h2>
            <form class="modal-form-request" action="">
                <div class="form-modal">
                    <label for="search-number">Numero</label>
                    <input type="text" id="search-number" name="search-number" placeholder="Ingrese numero" required>
                    <button type="button" class="search-request"><i class="bi bi-search"></i></button>
                </div>
            </form>
            <form class="modal-form-request" action="">
                <div class="form-modal">
                    <label for="search-client">Cliente</label>
                    <input type="text" id="search-client" name="search-client" placeholder="Ingrese cliente">
                    <button type="button" class="search-request"><i class="bi bi-search"></i></button>
                </div>
            </form>
            <div class="table-container">
                <table class="request-table">
                    ...
                    <tbody id="request-table-body">
                        <tr>
                            <td>001</td>
                            <td>Requerimiento de prueba</td>
                            <td>2023-10</td>
                            <td>
                                <input type="radio" name="request-select" value="001">
                            </td>
                        </tr>
                        <tr>
                            <td>002</td>
                            <td>Otro requerimiento</td>
                            <td>2023-10</td>
                            <td>
                                <input type="radio" name="request-select" value="001">
                            </td>
    ...
    <div id="myModalBusiness" class="myModalBusiness modal">
        <div class="modal-content">
            <span class="close" id="closeModalBusiness">&times;</span> <!-- Cierre único -->
            <h2>Empresa</h2>
            <form class="modal-form-request" action="">
                <div class="form-modal">
                    <label for="search-number">RUC</label>
                    <input type="text" id="search-number" name="search-number" placeholder="Ingrese numero" required>
                    <button type="button" class="search-request"><i class="bi bi-search"></i></button>
                </div>
            </form>
            <form class="modal-form-request" action="">
                <div class="form-modal">
                    <label for="search-client">Razón Social</label>
                    <input type="text" id="search-client" name="search-client" placeholder="Ingrese cliente">
                    <button type="button" class="search-request"><i class="bi bi-search"></i></button>
                </div>
            </form>
